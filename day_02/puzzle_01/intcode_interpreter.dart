class IntcodeInterpreter {
  ...
  void _opcodeAdd() {
    ...
    int addendOne = intcode[positions[0]];
    int addendTwo = intcode[positions[1]];
    intcode[positions[2]] = addendOne + addendTwo;
  ...
  void _opcodeMultiply() {
    ...
    int factorOne = intcode[positions[0]];
    int factorTwo = intcode[positions[1]];
    intcode[positions[2]] = factorOne * factorTwo;
